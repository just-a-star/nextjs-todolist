...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-6 bg-gray-50 dark:bg-gray-900">
      <div className="w-full max-w-4xl  text-center">
        <header className="w-full justify-items-center py-4 bg-gradient-to-r from-blue-500 to-teal-400 text-white rounded-lg shadow-md">
          <p className="m-2">
            Get started by making an account&nbsp;
            <Link href="/sign-up">
